...
//component rendered on all pages to route to different paths 
...
export default function NavigationBar() {
  return (
    <nav className="bg-gray-800 text-white p-4">
      ...
      {/*hidden memory game in right icon */}
      <NavLink to={'/memorygame'} className="group">
           <img src="https://cdn-icons-png.flaticon.com/512/5821/5821067.png" 
           alt="Placeholder" 
           className="absolute h-15 w-12 top-7 right-10 group-hover:animate-spin" />
      </NavLink>
