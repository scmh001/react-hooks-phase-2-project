    ...
    <div className="max-w-md mx-auto my-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <form id="drinksInputForm" onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input type="text" value={ingredients} onChange={e => setIngredients(e.target.value)} placeholder='Please separate instructions with a comma...' className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
        </div>
        <div>
        ...
        <div>
          ...
          <textarea value={instructions} onChange={e => setInstructions(e.target.value)} placeholder='Instructions' className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
        </div>
